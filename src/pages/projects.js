          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Digimon Deck Builder"
                summary="A web application which allows you create, edit, and delete a Digimon card deck. Created using MERN Stack (MongoDB, Express, React.JS, Node.JS)!"
                img={project1}
                link="https://banana-bunch-digi-deck.netlify.app/"
                github="https://github.com/nleung77/digimon-deck"
              />
            </div>
